...
--
-- Table structure for table `circular_recipients`
--

DROP TABLE IF EXISTS `circular_recipients`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `circular_recipients` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `circular_recipients_ibfk_1` FOREIGN KEY (`circular_id`) REFERENCES `circulars` (`id`) ON DELETE CASCADE,
  CONSTRAINT `circular_recipients_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `departments` (id, name, code) VALUES (1, 'Computer Science and Engineering (Cyber Security)', 'CSE-CS');
UNLOCK TABLES;
...
CREATE TABLE `timetable_slots` (
  ...
  `type` enum('theory','lab','tutorial','free') DEFAULT 'theory',
  `is_active` tinyint(1) DEFAULT '1',
  `semester` int DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2026-03-31 22:36:51
