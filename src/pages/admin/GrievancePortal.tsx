  ...
  return (
    <div className="p-4 sm:p-6 space-y-6 max-w-7xl mx-auto">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold tracking-tight">Admin Grievance Portal</h1>
          <p className="text-sm sm:text-base text-muted-foreground">Manage escalated complaints and issues</p>
        </div>
      </div>
                      ...
                      <Table>
                          <TableHeader>
                              <TableRow>
                                  ...
                                  <TableHead className="whitespace-nowrap">Batch/Section</TableHead>
