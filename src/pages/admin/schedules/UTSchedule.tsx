...
export default function UTSchedule() {
  const { user } = useAuth();
      ...
      <div className="-mx-6 -mt-6 p-6 bg-background/50 backdrop-blur-xl border-b border-white/10 sticky top-0 z-30">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 max-w-7xl mx-auto">
            <div>
              ...
              <p className="text-muted-foreground text-sm">Manage Unit Test schedules and timings</p>
            </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {selectedBatchId && selectedSemester ? (
                    ...
                    <div className="grid grid-cols-7 auto-rows-[140px] divide-x divide-white/10 divide-y bg-background/30">
                        {calendarDays.map((day, dayIdx) => {
                            ...
                            const dayEvents = events.filter(e => {
                                // Handle potential generic date strings
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="space-y-1">
                                        {dayEvents.map(event => (
                                            <div key={event.id} className="text-[10px] p-1 px-1.5 rounded bg-blue-500/10 border border-blue-500/20 text-blue-200 truncate font-medium flex items-center justify-between group/event">
            ...
            >
                ...
                <div>
                    ...
                    <p className="text-muted-foreground">Select a batch and semester from the header to view the schedule.</p>
                </div>
            </motion.div>
        )}
        </AnimatePresence>
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            <DialogContent className="sm:max-w-[425px] bg-background/95 backdrop-blur-xl border-white/10">
                <DialogHeader>
                    <DialogTitle>Schedule UT Exam</DialogTitle>
                    <DialogDescription>
                        Schedule a Unit Test for <strong>{selectedDate ? format(selectedDate, 'MMMM do, yyyy') : ''}</strong>
                    </DialogDescription>
                </DialogHeader>
