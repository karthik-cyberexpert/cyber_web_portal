# Tutor Leave Approvals Page Side Panel Analysis
**Component:** `src/components/dashboard/DashboardSidebar.tsx`

## 1. Navigation Context
The Leave Approvals page is accessible through the tutor-specific sidebar as part of the tutor dashboard ecosystem. It's represented by the "Leave Approvals" link with an ExternalLink icon in the sidebar navigation.

## 2. Sidebar Integration
- **Label**: "Leave Approvals"
- **Icon**: `ExternalLink` 
- **Route Path**: `/tutor/leave`
- **Purpose**: Student leave request processing

## 3. Positioning in Navigation
The Leave Approvals link appears as the twelfth and final item in the tutor navigation menu, positioned after the main dashboard, class analytics, personal details, my class, timetable, verify marks, notes status, assignment status, LMS analytics, ECA approvals, and circulars pages, reflecting its importance in student welfare management.

## 4. Visual Design
- Uses the `ExternalLink` icon to represent leave approvals functionality
...
- Links to the LeaveApprovals component which validates user permissions

## 6. User Experience
- Quick access to leave request processing tools
...
- Direct pathway from tutor dashboard to leave approval process
